...
function renderFooter (containerSelector, htmlPath) {
  ...
  fetch(htmlPath)
    ...
    .catch((err) => {
      ...
      container.innerHTML =
        '<div><a href="brand.html">Brand guidelines</a><div class="footer-copyright">© 2026 SillyLittleTech. Fiscally sponsored by The Hack Foundation (d.b.a. Hack Club), a 501(c)(3) nonprofit (EIN: 81-2908499).</div></div>'
    })
}
